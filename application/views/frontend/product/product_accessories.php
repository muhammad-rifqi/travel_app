...
<body>
    <div class="container">
        ...
        <div class="row">
          ...
          <li style="float: left; margin-right: 50px; margin-left: 385px;"><a style="color:black" href="<?= base_url('user/product_top/'.$this->uri->segment(3));?>">Tops</a></li>
              <li style="float: left; margin-right: 50px;"><a style="color:black" href="<?= base_url('user/product_bottom/'.$this->uri->segment(3));?>">Bottoms</a></li>
              <li style="float: left; margin-right: 50px;"><a style="color:black" href="<?= base_url('user/product_accessories/'.$this->uri->segment(3));?>">Accessories</a></li>
          </ul>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <span style="font-weight: 500;"> <?= $this->uri->segment(3) == 1 ? "Man's" : "Woman's" ?></span> / Accessories
          </div>
          <div class="col-md-6">
            <form action="#">
