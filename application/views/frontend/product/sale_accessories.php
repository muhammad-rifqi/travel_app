    ...
    <div class="container">
        ...
        <div class="row">
          <ul style="list-style: none; font-weight: 400; color: #6d6d6d;">
              <li style="float: left; margin-right: 50px; margin-left: 385px;"><a style="color:black" href="<?= base_url('user/sale_top');?>">Tops</a></li>
              <li style="float: left; margin-right: 50px;"><a style="color:black" href="<?= base_url('user/sale_bottom');?>">Bottoms</a></li>
              <li style="float: left; margin-right: 50px;"><a style="color:black" href="<?= base_url('user/sale_accessories');?>">Accessories</a></li>
          </ul>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <span style="font-weight: 500;">Sale's</span> / Accessories
          </div>
          <div class="col-md-6">
            <form action="#">
            ...
            <?php
              ...
              <div class="row">
                  ...
                  <div class="col-md-2" style="padding-bottom: 25px;">
                    ...
                    <p style="padding: 0; margin: 0; font-family: 'Roboto', sans-serif; font-weight: 100; font-size: 9pt;"> Sale : <?= $chunk[$i][$j]['sale'];?> </p>
